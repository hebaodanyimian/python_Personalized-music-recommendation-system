<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#d8ae86"}'>
		...
		>
			<template >
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="歌曲类型" prop="gequleixing">
					<el-input v-model="ruleForm.gequleixing" placeholder="歌曲类型" clearable  :readonly="ro.gequleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else class="input" label="歌曲类型" prop="gequleixing">
					<el-input v-model="ruleForm.gequleixing" placeholder="歌曲类型" readonly></el-input>
				</el-form-item>
			</template>
