<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 0px","margin":"0","position":"relative","background":"#f1f2f7","display":"block"} : {"minHeight":"100%","padding":"94px 0 0 240px","margin":"0","position":"relative","background":"#ebeff2","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0 20px 0 20px","margin":"0 auto","borderColor":"#71b6f9","alignItems":"center","color":"#fff","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#d8ae86","borderWidth":"3px 0 0","width":"calc(100% - 0px)","fontSize":"14px","position":"fixed","borderStyle":"solid","zIndex":"1000","height":"60px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"30px 30px","margin":"60px auto 0","borderColor":"#aaaaac","borderWidth":"0 0 1px","background":"#fff","display":"none","width":"100%","fontSize":"13px","borderStyle":"solid","zIndex":"9"}' class="bread-crumbs"></bread-crumbs>
