...
<div :style='{"border":"2px solid #DF847F","width":"90%","padding":"20px 0","margin":"10px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="歌名" prop="songname">
            <el-input v-model="ruleForm.songname" 
                placeholder="歌名" clearable :disabled=" false  ||ro.songname"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}'  label="歌曲类型" prop="gequleixing">
            <el-select v-model="ruleForm.gequleixing" placeholder="请选择歌曲类型" :disabled=" false  ||ro.gequleixing" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="歌手" prop="singer">
            <el-input v-model="ruleForm.singer" 
                placeholder="歌手" clearable :disabled=" false  ||ro.singer"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="语言" prop="yuyan">
            <el-input v-model="ruleForm.yuyan" 
                placeholder="语言" clearable :disabled=" false  ||ro.yuyan"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="音乐文件" prop="songfile">
            <file-upload
            tip="点击上传音乐文件"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="歌曲mv" v-if="type!='cross' || (type=='cross' && !ro.gequmv)" prop="gequmv">
            <file-upload
            tip="点击上传歌曲mv"
            action="file/upload"
            :limit="1"
		  ...
		  <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' class="upload" v-else label="歌曲mv" prop="gequmv">
			<el-button v-if="ruleForm.gequmv" @click="download(baseUrl + ruleForm.gequmv)" type="success">预览</el-button>
			<el-button v-else disabled>暂无</el-button>
		  </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="专辑" prop="zhuanji">
            <el-input v-model="ruleForm.zhuanji" 
                placeholder="专辑" clearable :disabled=" false  ||ro.zhuanji"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="时长" prop="shizhang">
            <el-input v-model="ruleForm.shizhang" 
                placeholder="时长" clearable :disabled=" false  ||ro.shizhang"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="发行方" prop="faxingfang">
            <el-input v-model="ruleForm.faxingfang" 
                placeholder="发行方" clearable :disabled=" false  ||ro.faxingfang"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="歌词" prop="lyric">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/gequleixing/gequleixing', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.gequleixingOptions = res.data.data;
          }
        });
    ...
    // 多级联动参数
      ...
      gequmvUploadChange(fileUrls) {
          this.ruleForm.gequmv = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");
      },
    }
  };
</script>
