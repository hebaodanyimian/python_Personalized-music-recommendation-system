...
<div :style='{"border":"2px solid #DF847F","width":"90%","padding":"20px 0","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    <div v-if="storeupType==1" class="section-title" :style='{"margin":"10px auto","color":"#DF847F","textAlign":"center","background":"url(http://codegen.caihongy.cn/20231220/e54f6cd4929f4d00b2ead8e5a5991d16.png)","width":"80%","fontSize":"24px","lineHeight":"54px","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","fontWeight":"bold"}'>我的收藏</div>
