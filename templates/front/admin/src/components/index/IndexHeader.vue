<template>
	<div class="navbar">
		<div class="title" :style='{"margin":"0","top":"0","textAlign":"center","left":"260px","background":"none","display":"block","width":"auto","position":"absolute","order":"1"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"60px","fontSize":"22px","color":"inherit","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"padding":"0px","margin":"0 10px 0 0","color":"inherit","background":"none","display":"inline-block","fontSize":"inherit","order":"10"}'>
