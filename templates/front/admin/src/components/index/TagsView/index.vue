<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0 30px","boxShadow":"0px 0px 0px #ccc","margin":"0","borderColor":"#eee","overflow":"hidden","top":"60px","background":"#d8ae86","borderWidth":"1px 0","width":"calc(100% - 0px)","fontSize":"15px","position":"fixed","borderStyle":"solid","height":"auto","zIndex":"9"}'>
